...
<html lang="en-US" dir="ltr">
  ...
  <body>
    ...
    <main style="--phoenix-scroll-margin-top: 1.2rem;">
      ...
      @include('front-end.layouts.top-navbar')

      @include('front-end.layouts.top-navbar-search')


      @include('front-end.layouts.home-main-section')


      @include('front-end.layouts.home-section-brand')
