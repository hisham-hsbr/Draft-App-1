            ...
            <div class="dropdown-menu border border-300 font-base start-0 py-0 overflow-hidden w-100">
              <div class="scrollbar-overlay" style="max-height: 30rem;">
                <div class="list pb-3">
                  ...
                  <div class="py-2"><a class="dropdown-item" href="{{ asset('back-end-links/phoenix/apps/e-commerce/landing/product-details.html') }}">
                    ...
                    <a class="dropdown-item" href="{{ asset('back-end-links/phoenix/apps/e-commerce/landing/product-details.html') }}">
                      <div class="d-flex align-items-center">
                  ...
                  <div class="py-2"><a class="dropdown-item py-2 d-flex align-items-center" href="{{ asset('back-end-links/phoenix/apps/e-commerce/landing/product-details.html') }}">
                    ...
                    <a class="dropdown-item py-2 d-flex align-items-center" href="{{ asset('back-end-links/phoenix/apps/e-commerce/landing/product-details.html') }}">
                  ...
                  <div class="py-2"><a class="dropdown-item py-2 d-flex align-items-center" href="{{ asset('back-end-links/phoenix/pages/members.html') }}">
                    ...
                    <a class="dropdown-item py-2 d-flex align-items-center" href="{{ asset('back-end-links/phoenix/pages/members.html') }}">
