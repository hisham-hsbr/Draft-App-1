            ...
            <div class="row gx-2">
                <div class="col-6">
                    <input class="btn-check" id="navbarPositionVertical" name="navigation-type" type="radio"
                        ...
                        data-page-url="{{ asset('back-end-links/phoenix/documentation/layouts/vertical-navbar.html') }}" />
                ...
                <div class="col-6">
                    <input class="btn-check" id="navbarPositionHorizontal" name="navigation-type" type="radio"
                        ...
                        data-page-url="{{ asset('back-end-links/phoenix/documentation/layouts/horizontal-navbar.html') }}" />
                ...
                <div class="col-6">
                    <input class="btn-check" id="navbarPositionCombo" name="navigation-type" type="radio"
                        ...
                        data-page-url="{{ asset('back-end-links/phoenix/documentation/layouts/combo-navbar.html') }}" />
                ...
                <div class="col-6">
                    <input class="btn-check" id="navbarPositionTopDouble" name="navigation-type" type="radio"
                        ...
                        data-page-url="{{ asset('back-end-links/phoenix/documentation/layouts/dual-nav.html') }}" />
            ...
            <div class="row gx-2">
                ...
                <div class="col-6">
                    <input class="btn-check" id="navbarShapeSlim" name="navbar-shape" type="radio" value="slim"
                        ...
                        data-page-url="{{ asset('back-end-links/phoenix/documentation/layouts/horizontal-navbar.html#horizontal-navbar-slim') }}" />
