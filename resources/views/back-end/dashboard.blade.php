...
@section('add-head-links')
    ...
    <link href="{{ asset('back-end-links/phoenix/public/vendors/leaflet.markercluster/MarkerCluster.css') }}"
        rel="stylesheet" />
    <link href="{{ asset('back-end-links/phoenix/public/vendors/leaflet.markercluster/MarkerCluster.Default.css') }}"
        rel="stylesheet" />
@endsection
...
@section('add-footer-links')
    ...
    <script src="{{ asset('back-end-links/phoenix/public/vendors/leaflet.markercluster/leaflet.markercluster.js') }}">
    </script>
    <script
