...
<head>
    ...
    <!--    Favicons-->
    <!-- ===============================================-->
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('back-end-links/phoenix/public/assets/img/favicons/apple-touch-icon.png') }}" />
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('back-end-links/phoenix/public/assets/img/favicons/favicon-32x32.png') }}" />
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('back-end-links/phoenix/public/assets/img/favicons/favicon-16x16.png') }}" />
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('back-end-links/phoenix/public/assets/img/favicons/favicon.ico') }}" />
    <link rel="manifest" href="{{ asset('back-end-links/phoenix/public/assets/img/favicons/manifest.json') }}" />
    <meta name="msapplication-TileImage" content="{{ asset('back-end-links/phoenix/public/assets/img/favicons/mstile-150x150.png') }}" />
    ...
    <link href="{{ asset('back-end-links/phoenix/public/assets/css/theme-rtl.min.css') }}" type="text/css" rel="stylesheet" id="style-rtl" />
    <link href="{{ asset('back-end-links/phoenix/public/assets/css/theme.min.css') }}" type="text/css" rel="stylesheet" id="style-default" />
    <link href="{{ asset('back-end-links/phoenix/public/assets/css/user-rtl.min.css') }}" type="text/css" rel="stylesheet" id="user-style-rtl" />
    <link href="{{ asset('back-end-links/phoenix/public/assets/css/user.min.css') }}" type="text/css" rel="stylesheet" id="user-style-default" />
    <script>
    ...
    <link href="{{ asset('back-end-links/phoenix/public/vendors/leaflet/leaflet.css') }}" rel="stylesheet" />
    <link href="{{ asset('back-end-links/phoenix/public/vendors/leaflet.markercluster/MarkerCluster.css') }}" rel="stylesheet" />
    <link href="{{ asset('back-end-links/phoenix/public/vendors/leaflet.markercluster/MarkerCluster.Default.css') }}" rel="stylesheet" />
</head>
...
<body>
                ...
                <div class="navbar-vertical-content">
                    <ul class="navbar-nav flex-column" id="navbarVerticalNav">
                            ...
                            <div class="nav-item-wrapper">
                                ...
                                <div class="parent-wrapper label-1">
                                    <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse"
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ asset('back-end-links/phoenix/public/apps/social/feed.html') }}" data-bs-toggle=""
                                                aria-expanded="false">
                                                <div class="d-flex align-items-center">
                        ...
                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <div class="parent-wrapper">
                                                <ul class="nav collapse parent show" data-bs-parent="#e-commerce"
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link"
                                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/admin/add-product.html') }}"
                                                            data-bs-toggle="" aria-expanded="false">
                                                            <div class="d-flex align-items-center">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/admin/products.html') }}"
                                                            data-bs-toggle="" aria-expanded="false">
                                                            <div class="d-flex align-items-center">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link"
                                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/admin/customers.html') }}"
                                                            data-bs-toggle="" aria-expanded="false">
                                                            <div class="d-flex align-items-center">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link"
                                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/admin/customer-details.html') }}"
                                                            data-bs-toggle="" aria-expanded="false">
                                                            <div class="d-flex align-items-center">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/admin/orders.html') }}"
                                                            data-bs-toggle="" aria-expanded="false">
                                                            <div class="d-flex align-items-center">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link"
                                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/admin/order-details.html') }}"
                                                            data-bs-toggle="" aria-expanded="false">
                                                            <div class="d-flex align-items-center">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/admin/refund.html') }}"
                                                            data-bs-toggle="" aria-expanded="false">
                                                            <div class="d-flex align-items-center">
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <div class="parent-wrapper">
                                                <ul class="nav collapse parent show" data-bs-parent="#e-commerce"
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link"
                                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/homepage.html') }}"
                                                            data-bs-toggle="" aria-expanded="false">
                                                            <div class="d-flex align-items-center">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link"
                                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/product-details.html') }}"
                                                            data-bs-toggle="" aria-expanded="false">
                                                            <div class="d-flex align-items-center">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link"
                                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/products-filter.html') }}"
                                                            data-bs-toggle="" aria-expanded="false">
                                                            <div class="d-flex align-items-center">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/cart.html') }}"
                                                            data-bs-toggle="" aria-expanded="false">
                                                            <div class="d-flex align-items-center">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link"
                                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/checkout.html') }}"
                                                            data-bs-toggle="" aria-expanded="false">
                                                            <div class="d-flex align-items-center">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link"
                                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/shipping-info.html') }}"
                                                            data-bs-toggle="" aria-expanded="false">
                                                            <div class="d-flex align-items-center">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link"
                                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/profile.html') }}"
                                                            data-bs-toggle="" aria-expanded="false">
                                                            <div class="d-flex align-items-center">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link"
                                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/favourite-stores.html') }}"
                                                            data-bs-toggle="" aria-expanded="false">
                                                            <div class="d-flex align-items-center">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link"
                                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/wishlist.html') }}"
                                                            data-bs-toggle="" aria-expanded="false">
                                                            <div class="d-flex align-items-center">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link"
                                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/order-tracking.html') }}"
                                                            data-bs-toggle="" aria-expanded="false">
                                                            <div class="d-flex align-items-center">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link"
                                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/invoice.html') }}"
                                                            data-bs-toggle="" aria-expanded="false">
                                                            <div class="d-flex align-items-center">
                            ...
                            <div class="nav-item-wrapper">
                                ...
                                <div class="parent-wrapper label-1">
                                    <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse"
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ asset('back-end-links/phoenix/public/apps/crm/analytics.html') }}" data-bs-toggle=""
                                                aria-expanded="false">
                                                <div class="d-flex align-items-center">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ asset('back-end-links/phoenix/public/apps/crm/deals.html') }}" data-bs-toggle=""
                                                aria-expanded="false">
                                                <div class="d-flex align-items-center">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ asset('back-end-links/phoenix/public/apps/crm/deal-details.html') }}" data-bs-toggle=""
                                                aria-expanded="false">
                                                <div class="d-flex align-items-center">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ asset('back-end-links/phoenix/public/apps/crm/leads.html') }}" data-bs-toggle=""
                                                aria-expanded="false">
                                                <div class="d-flex align-items-center">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ asset('back-end-links/phoenix/public/apps/crm/lead-details.html') }}" data-bs-toggle=""
                                                aria-expanded="false">
                                                <div class="d-flex align-items-center">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ asset('back-end-links/phoenix/public/apps/crm/reports.html') }}" data-bs-toggle=""
                                                aria-expanded="false">
                                                <div class="d-flex align-items-center">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ asset('back-end-links/phoenix/public/apps/crm/reports-details.html') }}"
                                                data-bs-toggle="" aria-expanded="false">
                                                <div class="d-flex align-items-center">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ asset('back-end-links/phoenix/public/apps/crm/add-contact.html') }}" data-bs-toggle=""
                                                aria-expanded="false">
                                                <div class="d-flex align-items-center">
                            ...
                            <div class="nav-item-wrapper">
                                ...
                                <div class="parent-wrapper label-1">
                                    <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse"
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ asset('back-end-links/phoenix/public/apps/project-management/create-new.html') }}"
                                                data-bs-toggle="" aria-expanded="false">
                                                <div class="d-flex align-items-center">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ asset('back-end-links/phoenix/public/apps/project-management/project-list-view.html') }}"
                                                data-bs-toggle="" aria-expanded="false">
                                                <div class="d-flex align-items-center">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ asset('back-end-links/phoenix/public/apps/project-management/project-card-view.html') }}"
                                                data-bs-toggle="" aria-expanded="false">
                                                <div class="d-flex align-items-center">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ asset('back-end-links/phoenix/public/apps/project-management/project-board-view.html') }}"
                                                data-bs-toggle="" aria-expanded="false">
                                                <div class="d-flex align-items-center">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ asset('back-end-links/phoenix/public/apps/project-management/todo-list.html') }}"
                                                data-bs-toggle="" aria-expanded="false">
                                                <div class="d-flex align-items-center">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ asset('back-end-links/phoenix/public/apps/project-management/project-details.html') }}"
                                                data-bs-toggle="" aria-expanded="false">
                                                <div class="d-flex align-items-center">
                            ...
                            <!-- parent pages-->
                            <div class="nav-item-wrapper">
                                <a class="nav-link label-1" href="{{ asset('back-end-links/phoenix/public/apps/chat.html') }}" role="button" data-bs-toggle=""
                                    aria-expanded="false">
                                    <div class="d-flex align-items-center">
                                        <span class="nav-link-icon"><span
                            ...
                            <div class="nav-item-wrapper">
                                ...
                                <div class="parent-wrapper label-1">
                                    <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse"
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ asset('back-end-links/phoenix/public/apps/email/inbox.html') }}" data-bs-toggle=""
                                                aria-expanded="false">
                                                <div class="d-flex align-items-center">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ asset('back-end-links/phoenix/public/apps/email/email-detail.html') }}" data-bs-toggle=""
                                                aria-expanded="false">
                                                <div class="d-flex align-items-center">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ asset('back-end-links/phoenix/public/apps/email/compose.html') }}" data-bs-toggle=""
                                                aria-expanded="false">
                                                <div class="d-flex align-items-center">
                            ...
                            <div class="nav-item-wrapper">
                                ...
                                <div class="parent-wrapper label-1">
                                    <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse"
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ asset('back-end-links/phoenix/public/apps/events/create-an-event.html') }}"
                                                data-bs-toggle="" aria-expanded="false">
                                                <div class="d-flex align-items-center">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ asset('back-end-links/phoenix/public/apps/events/event-detail.html') }}"
                                                data-bs-toggle="" aria-expanded="false">
                                                <div class="d-flex align-items-center">
                            ...
                            <div class="nav-item-wrapper">
                                ...
                                <div class="parent-wrapper label-1">
                                    <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse"
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ asset('back-end-links/phoenix/public/apps/kanban/kanban.html') }}" data-bs-toggle=""
                                                aria-expanded="false">
                                                <div class="d-flex align-items-center">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ asset('back-end-links/phoenix/public/apps/kanban/boards.html') }}" data-bs-toggle=""
                                                aria-expanded="false">
                                                <div class="d-flex align-items-center">
                                                    <span class="nav-link-text">Boards</span><span
                                                        class="badge ms-2 badge badge-phoenix badge-phoenix-info">New</span>
                                                </div>
                                            </a>
                                            <!-- more inner pages-->
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ asset('back-end-links/phoenix/public/apps/kanban/create-kanban-board.html') }}"
                                                data-bs-toggle="" aria-expanded="false">
                                                <div class="d-flex align-items-center">
                            ...
                            <div class="nav-item-wrapper">
                                ...
                                <div class="parent-wrapper label-1">
                                    <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse"
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ asset('back-end-links/phoenix/public/apps/social/profile.html') }}" data-bs-toggle=""
                                                aria-expanded="false">
                                                <div class="d-flex align-items-center">
                                                    <span class="nav-link-text">Profile</span>
                                                </div>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ asset('back-end-links/phoenix/public/apps/social/settings.html') }}" data-bs-toggle=""
                                                aria-expanded="false">
                                                <div class="d-flex align-items-center">
                            ...
                            <!-- parent pages-->
                            <div class="nav-item-wrapper">
                                <a class="nav-link label-1" href="{{ asset('back-end-links/phoenix/public/apps/calendar.html') }}" role="button"
                                    data-bs-toggle="" aria-expanded="false">
                                    <div class="d-flex align-items-center">
                                        <span class="nav-link-icon"><span data-feather="calendar"></span></span><span
                                            class="nav-link-text-wrapper"><span
                        ...
                        <li class="nav-item">
                            ...
                            <!-- parent pages-->
                            <div class="nav-item-wrapper">
                                <a class="nav-link label-1" href="{{ asset('back-end-links/phoenix/public/pages/starter.html') }}" role="button"
                                    data-bs-toggle="" aria-expanded="false">
                                    <div class="d-flex align-items-center">
                                        <span class="nav-link-icon"><span data-feather="compass"></span></span><span
                                            class="nav-link-text-wrapper"><span
                            ...
                            <div class="nav-item-wrapper">
                                ...
                                <div class="parent-wrapper label-1">
                                    <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse"
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ asset('back-end-links/phoenix/public/pages/faq/faq-accordion.html') }}" data-bs-toggle=""
                                                aria-expanded="false">
                                                <div class="d-flex align-items-center">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ asset('back-end-links/phoenix/public/pages/faq/faq-tab.html') }}" data-bs-toggle=""
                                                aria-expanded="false">
                                                <div class="d-flex align-items-center">
                                                    <span class="nav-link-text">Faq tab</span><span
                                                        class="badge ms-2 badge badge-phoenix badge-phoenix-info">New</span>
                                                </div>
                                            </a>
                                            <!-- more inner pages-->
                            ...
                            <div class="nav-item-wrapper">
                                ...
                                <div class="parent-wrapper label-1">
                                    <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse"
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ asset('back-end-links/phoenix/public/pages/landing/default.html') }}" data-bs-toggle=""
                                                aria-expanded="false">
                                                <div class="d-flex align-items-center">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ asset('back-end-links/phoenix/public/pages/landing/alternate.html') }}" data-bs-toggle=""
                                                aria-expanded="false">
                                                <div class="d-flex align-items-center">
                            ...
                            <div class="nav-item-wrapper">
                                ...
                                <div class="parent-wrapper label-1">
                                    <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse"
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ asset('back-end-links/phoenix/public/pages/pricing/pricing-column.html') }}"
                                                data-bs-toggle="" aria-expanded="false">
                                                <div class="d-flex align-items-center">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ asset('back-end-links/phoenix/public/pages/pricing/pricing-grid.html') }}"
                                                data-bs-toggle="" aria-expanded="false">
                                                <div class="d-flex align-items-center">
                            ...
                            <!-- parent pages-->
                            <div class="nav-item-wrapper">
                                <a class="nav-link label-1" href="{{ asset('back-end-links/phoenix/public/pages/notifications.html') }}" role="button"
                                    data-bs-toggle="" aria-expanded="false">
                                    <div class="d-flex align-items-center">
                                        <span class="nav-link-icon"><span data-feather="bell"></span></span><span
                                            class="nav-link-text-wrapper"><span
                            ...
                            <!-- parent pages-->
                            <div class="nav-item-wrapper">
                                <a class="nav-link label-1" href="{{ asset('back-end-links/phoenix/public/pages/members.html') }}" role="button"
                                    data-bs-toggle="" aria-expanded="false">
                                    <div class="d-flex align-items-center">
                            ...
                            <!-- parent pages-->
                            <div class="nav-item-wrapper">
                                <a class="nav-link label-1" href="{{ asset('back-end-links/phoenix/public/pages/timeline.html') }}" role="button"
                                    data-bs-toggle="" aria-expanded="false">
                                    <div class="d-flex align-items-center">
                                        <span class="nav-link-icon"><span data-feather="clock"></span></span><span
                                            class="nav-link-text-wrapper"><span
                            ...
                            <div class="nav-item-wrapper">
                                ...
                                <div class="parent-wrapper label-1">
                                    <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse"
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ asset('back-end-links/phoenix/public/pages/errors/404.html') }}" data-bs-toggle=""
                                                aria-expanded="false">
                                                <div class="d-flex align-items-center">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ asset('back-end-links/phoenix/public/pages/errors/403.html') }}" data-bs-toggle=""
                                                aria-expanded="false">
                                                <div class="d-flex align-items-center">
                                                    <span class="nav-link-text">403</span><span
                                                        class="badge ms-2 badge badge-phoenix badge-phoenix-info">New</span>
                                                </div>
                                            </a>
                                            <!-- more inner pages-->
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ asset('back-end-links/phoenix/public/pages/errors/500.html') }}" data-bs-toggle=""
                                                aria-expanded="false">
                                                <div class="d-flex align-items-center">
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <div class="parent-wrapper">
                                                <ul class="nav collapse parent" data-bs-parent="#authentication"
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link"
                                                            href="{{ asset('back-end-links/phoenix/public/pages/authentication/simple/sign-in.html') }}"
                                                            data-bs-toggle="" aria-expanded="false">
                                                            <div class="d-flex align-items-center">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link"
                                                            href="{{ asset('back-end-links/phoenix/public/pages/authentication/simple/sign-up.html') }}"
                                                            data-bs-toggle="" aria-expanded="false">
                                                            <div class="d-flex align-items-center">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link"
                                                            href="{{ asset('back-end-links/phoenix/public/pages/authentication/simple/sign-out.html') }}"
                                                            data-bs-toggle="" aria-expanded="false">
                                                            <div class="d-flex align-items-center">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link"
                                                            href="{{ asset('back-end-links/phoenix/public/pages/authentication/simple/forgot-password.html') }}"
                                                            data-bs-toggle="" aria-expanded="false">
                                                            <div class="d-flex align-items-center">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link"
                                                            href="{{ asset('back-end-links/phoenix/public/pages/authentication/simple/reset-password.html') }}"
                                                            data-bs-toggle="" aria-expanded="false">
                                                            <div class="d-flex align-items-center">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link"
                                                            href="{{ asset('back-end-links/phoenix/public/pages/authentication/simple/lock-screen.html') }}"
                                                            data-bs-toggle="" aria-expanded="false">
                                                            <div class="d-flex align-items-center">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link"
                                                            href="{{ asset('back-end-links/phoenix/public/pages/authentication/simple/2FA.html') }}"
                                                            data-bs-toggle="" aria-expanded="false">
                                                            <div class="d-flex align-items-center">
                                                                <span class="nav-link-text">2FA</span><span
                                                                    class="badge ms-2 badge badge-phoenix badge-phoenix-info">New</span>
                                                            </div>
                                                        </a>
                                                        <!-- more inner pages-->
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <div class="parent-wrapper">
                                                <ul class="nav collapse parent" data-bs-parent="#authentication"
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link"
                                                            href="{{ asset('back-end-links/phoenix/public/pages/authentication/split/sign-in.html') }}"
                                                            data-bs-toggle="" aria-expanded="false">
                                                            <div class="d-flex align-items-center">
                                                                <span class="nav-link-text">Sign in</span>
                                                            </div>
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link"
                                                            href="{{ asset('back-end-links/phoenix/public/pages/authentication/split/sign-up.html') }}"
                                                            data-bs-toggle="" aria-expanded="false">
                                                            <div class="d-flex align-items-center">
                                                                <span class="nav-link-text">Sign up</span>
                                                            </div>
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link"
                                                            href="{{ asset('back-end-links/phoenix/public/pages/authentication/split/sign-out.html') }}"
                                                            data-bs-toggle="" aria-expanded="false">
                                                            <div class="d-flex align-items-center">
                                                                <span class="nav-link-text">Sign out</span>
                                                            </div>
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link"
                                                            href="{{ asset('back-end-links/phoenix/public/pages/authentication/split/forgot-password.html') }}"
                                                            data-bs-toggle="" aria-expanded="false">
                                                            <div class="d-flex align-items-center">
                                                                <span class="nav-link-text">Forgot password</span>
                                                            </div>
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link"
                                                            href="{{ asset('back-end-links/phoenix/public/pages/authentication/split/reset-password.html') }}"
                                                            data-bs-toggle="" aria-expanded="false">
                                                            <div class="d-flex align-items-center">
                                                                <span class="nav-link-text">Reset password</span>
                                                            </div>
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link"
                                                            href="{{ asset('back-end-links/phoenix/public/pages/authentication/split/lock-screen.html') }}"
                                                            data-bs-toggle="" aria-expanded="false">
                                                            <div class="d-flex align-items-center">
                                                                <span class="nav-link-text">Lock screen</span>
                                                            </div>
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="{{ asset('back-end-links/phoenix/public/pages/authentication/split/2FA.html') }}"
                                                            data-bs-toggle="" aria-expanded="false">
                                                            <div class="d-flex align-items-center">
                                                                <span class="nav-link-text">2FA</span><span
                                                                    class="badge ms-2 badge badge-phoenix badge-phoenix-info">New</span>
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <div class="parent-wrapper">
                                                <ul class="nav collapse parent" data-bs-parent="#authentication"
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link"
                                                            href="{{ asset('back-end-links/phoenix/public/pages/authentication/card/sign-in.html') }}"
                                                            data-bs-toggle="" aria-expanded="false">
                                                            <div class="d-flex align-items-center">
                                                                <span class="nav-link-text">Sign in</span>
                                                            </div>
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link"
                                                            href="{{ asset('back-end-links/phoenix/public/pages/authentication/card/sign-up.html') }}"
                                                            data-bs-toggle="" aria-expanded="false">
                                                            <div class="d-flex align-items-center">
                                                                <span class="nav-link-text">Sign up</span>
                                                            </div>
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link"
                                                            href="{{ asset('back-end-links/phoenix/public/pages/authentication/card/sign-out.html') }}"
                                                            data-bs-toggle="" aria-expanded="false">
                                                            <div class="d-flex align-items-center">
                                                                <span class="nav-link-text">Sign out</span>
                                                            </div>
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link"
                                                            href="{{ asset('back-end-links/phoenix/public/pages/authentication/card/forgot-password.html') }}"
                                                            data-bs-toggle="" aria-expanded="false">
                                                            <div class="d-flex align-items-center">
                                                                <span class="nav-link-text">Forgot password</span>
                                                            </div>
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link"
                                                            href="{{ asset('back-end-links/phoenix/public/pages/authentication/card/reset-password.html') }}"
                                                            data-bs-toggle="" aria-expanded="false">
                                                            <div class="d-flex align-items-center">
                                                                <span class="nav-link-text">Reset password</span>
                                                            </div>
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link"
                                                            href="{{ asset('back-end-links/phoenix/public/pages/authentication/card/lock-screen.html') }}"
                                                            data-bs-toggle="" aria-expanded="false">
                                                            <div class="d-flex align-items-center">
                                                                <span class="nav-link-text">Lock screen</span>
                                                            </div>
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="{{ asset('back-end-links/phoenix/public/pages/authentication/card/2FA.html') }}"
                                                            data-bs-toggle="" aria-expanded="false">
                                                            <div class="d-flex align-items-center">
                                                                <span class="nav-link-text">2FA</span><span
                                                                    class="badge ms-2 badge badge-phoenix badge-phoenix-info">New</span>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="nav-item-wrapper">
                                <a class="nav-link label-1" href="widgets.html') }}" role="button" data-bs-toggle=""
                                    aria-expanded="false">
                                    <div class="d-flex align-items-center">
                                        <span class="nav-link-icon"><span data-feather="server"></span></span><span
                                            class="nav-link-text-wrapper"><span
                        ...
                        <li class="nav-item">
                            ...
                            <div class="nav-item-wrapper">
                                <a class="nav-link label-1" href="documentation/design-file.html') }}" role="button"
                                    data-bs-toggle="" aria-expanded="false">
                                    <div class="d-flex align-items-center">
                                        <span class="nav-link-icon"><span data-feather="figma"></span></span><span
            ...
            <div class="collapse navbar-collapse justify-content-between">
                <div class="navbar-logo">
                    ...
                    <a class="navbar-brand me-1 me-sm-3" href="index.html') }}">
                        <div class="d-flex align-items-center">
                            <div class="d-flex align-items-center">
                                <img src="{{ asset('back-end-links/phoenix/public/assets/img/icons/logo.png') }}" alt="phoenix" width="27" />
                            ...
                            <div class="list pb-3">
                                ...
                                <div class="py-2">
                                    <a class="dropdown-item py-2 d-flex align-items-center"
                                        ...
                                        <div class="file-thumbnail me-2">
                                            <img class="h-100 w-100 fit-cover rounded-3"
                                                src="{{ asset('back-end-links/phoenix/public/assets/img/products/60x60/3.png') }}" alt="" />
                                        </div>
                                        <div class="flex-1">
                                    ...
                                    <a class="dropdown-item py-2 d-flex align-items-center"
                                        href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/product-details.html') }}">
                                        <div class="file-thumbnail me-2">
                                            <img class="img-fluid" src="{{ asset('back-end-links/phoenix/public/assets/img/products/60x60/3.png') }}"
                                                alt="" />
                                        </div>
                                        <div class="flex-1">
                                ...
                                <div class="py-2">
                                    <a class="dropdown-item py-2 d-flex align-items-center"
                                        href="{{ asset('back-end-links/phoenix/public/pages/members.html') }}">
                                        <div class="avatar avatar-l status-online me-2 text-900">
                                            <img class="rounded-circle" src="{{ asset('back-end-links/phoenix/public/assets/img/team/40x40/10.webp') }}"
                                                alt="" />
                                        </div>
                                        <div class="flex-1">
                                    ...
                                    <a class="dropdown-item py-2 d-flex align-items-center"
                                        ...
                                        <div class="avatar avatar-l me-2 text-900">
                                            <img class="rounded-circle" src="{{ asset('back-end-links/phoenix/public/assets/img/team/40x40/12.webp') }}"
                                                alt="" />
                                        </div>
                                        <div class="flex-1">
                            ...
                            <div class="card position-relative border-0">
                                ...
                                <div class="card-footer p-0 border-top border-0">
                                    <div class="my-2 text-center fw-bold fs--2 text-600">
                                        <a class="fw-bolder" href="{{ asset('back-end-links/phoenix/public/pages/notifications.html') }}">Notification
                                            history</a>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row text-center align-items-center gx-0 gy-0">
                                        <div class="col-4">
                                            <a class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                                href="#!"><img src="{{ asset('back-end-links/phoenix/public/assets/img/nav-icons/behance.webp') }}"
                                                    alt="" width="30" />
                                        ...
                                        <div class="col-4">
                                            <a class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                                href="#!"><img src="{{ asset('back-end-links/phoenix/public/assets/img/nav-icons/google-cloud.webp') }}"
                                                    alt="" width="30" />
                                                <p class="mb-0 text-black text-truncate fs--2 mt-1 pt-1">
                                                    Cloud
                                                </p>
                                        ...
                                        <div class="col-4">
                                            <a class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                                href="#!"><img src="{{ asset('back-end-links/phoenix/public/assets/img/nav-icons/slack.webp') }}"
                                                    alt="" width="30" />
                                                <p class="mb-0 text-black text-truncate fs--2 mt-1 pt-1">
                                                    Slack
                                                </p>
                                        ...
                                        <div class="col-4">
                                            <a class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                                href="#!"><img src="{{ asset('back-end-links/phoenix/public/assets/img/nav-icons/gitlab.webp') }}"
                                                    alt="" width="30" />
                                                <p class="mb-0 text-black text-truncate fs--2 mt-1 pt-1">
                                                    Gitlab
                                                </p>
                                        ...
                                        <div class="col-4">
                                            <a class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                                href="#!"><img src="{{ asset('back-end-links/phoenix/public/assets/img/nav-icons/bitbucket.webp') }}"
                                                    alt="" width="30" />
                                                <p class="mb-0 text-black text-truncate fs--2 mt-1 pt-1">
                                                    BitBucket
                                                </p>
                                        ...
                                        <div class="col-4">
                                            <a class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                                href="#!"><img src="{{ asset('back-end-links/phoenix/public/assets/img/nav-icons/google-drive.webp') }}"
                                                    alt="" width="30" />
                                                <p class="mb-0 text-black text-truncate fs--2 mt-1 pt-1">
                                                    Drive
                                                </p>
                                        ...
                                        <div class="col-4">
                                            <a class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                                href="#!"><img src="{{ asset('back-end-links/phoenix/public/assets/img/nav-icons/trello.webp') }}"
                                                    alt="" width="30" />
                                                <p class="mb-0 text-black text-truncate fs--2 mt-1 pt-1">
                                                    Trello
                                                </p>
                                        ...
                                        <div class="col-4">
                                            <a class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                                href="#!"><img src="{{ asset('back-end-links/phoenix/public/assets/img/nav-icons/figma.webp') }}"
                                                    alt="" width="20" />
                                                <p class="mb-0 text-black text-truncate fs--2 mt-1 pt-1">
                                                    Figma
                                                </p>
                                        ...
                                        <div class="col-4">
                                            <a class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                                href="#!"><img src="{{ asset('back-end-links/phoenix/public/assets/img/nav-icons/twitter.webp') }}"
                                                    alt="" width="30" />
                                                <p class="mb-0 text-black text-truncate fs--2 mt-1 pt-1">
                                                    Twitter
                                                </p>
                                        ...
                                        <div class="col-4">
                                            <a class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                                href="#!"><img src="{{ asset('back-end-links/phoenix/public/assets/img/nav-icons/pinterest.webp') }}"
                                                    alt="" width="30" />
                                                <p class="mb-0 text-black text-truncate fs--2 mt-1 pt-1">
                                                    Pinterest
                                                </p>
                                        ...
                                        <div class="col-4">
                                            <a class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                                href="#!"><img src="{{ asset('back-end-links/phoenix/public/assets/img/nav-icons/ln.webp') }}"
                                                    alt="" width="30" />
                                                <p class="mb-0 text-black text-truncate fs--2 mt-1 pt-1">
                                                    Linkedin
                                                </p>
                                        ...
                                        <div class="col-4">
                                            <a class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                                href="#!"><img src="{{ asset('back-end-links/phoenix/public/assets/img/nav-icons/google-maps.webp') }}"
                                                    alt="" width="30" />
                                                <p class="mb-0 text-black text-truncate fs--2 mt-1 pt-1">
                                                    Maps
                                                </p>
                                        ...
                                        <div class="col-4">
                                            <a class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                                href="#!"><img src="{{ asset('back-end-links/phoenix/public/assets/img/nav-icons/google-photos.webp') }}"
                                                    alt="" width="30" />
                                                <p class="mb-0 text-black text-truncate fs--2 mt-1 pt-1">
                                                    Photos
                                                </p>
                                        ...
                                        <div class="col-4">
                                            <a class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                                href="#!"><img src="{{ asset('back-end-links/phoenix/public/assets/img/nav-icons/spotify.webp') }}"
                                                    alt="" width="30" />
                                                <p class="mb-0 text-black text-truncate fs--2 mt-1 pt-1">
                                                    Spotify
                                                </p>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link lh-1 pe-0" id="navbarDropdownUser" href="#!" role="button"
                            ...
                            <div class="avatar avatar-l">
                                <img class="rounded-circle" src="{{ asset('back-end-links/phoenix/public/assets/img/team/40x40/57.webp') }}" alt="" />
                            </div>
                        </a>
                            ...
                            <div class="card position-relative border-0">
                                <div class="card-body p-0">
                                    <div class="text-center pt-4 pb-3">
                                        <div class="avatar avatar-xl">
                                            <img class="rounded-circle" src="{{ asset('back-end-links/phoenix/public/assets/img/team/72x72/57.webp') }}"
                                                alt="" />
                                        </div>
                                ...
                                <div class="overflow-auto scrollbar" style="height: 10rem">
                                    <ul class="nav d-flex flex-column mb-2 pb-1">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link px-3" href="#!">
                                                <span class="me-2 text-900" data-feather="help-circle"></span>Help
                                                Center</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link px-3" href="#!">
                                ...
                                <div class="card-footer p-0 border-top">
                                    <ul class="nav d-flex flex-column my-3">
                                        <li class="nav-item">
                                            <a class="nav-link px-3" href="#!">
                                                <span class="me-2 text-900" data-feather="user-plus"></span>Add
                                                another account</a>
                                        </li>
                                    </ul>
                                    <hr />
                            ...
                            <tbody class="list" id="table-latest-review-body">
                                <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                    ...
                                    <td class="align-middle product white-space-nowrap py-0">
                                        <a class="d-block rounded-2 border"
                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/product-details.html') }}"><img
                                                src="{{ asset('back-end-links/phoenix/public/assets/img//products/60x60/1.png') }}" alt=""
                                                width="53" /></a>
                                    </td>
                                    <td class="align-middle product white-space-nowrap">
                                        <a class="fw-semi-bold"
                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/product-details.html') }}">Fitbit Sense Advanced
                                ...
                                <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                    ...
                                    <td class="align-middle product white-space-nowrap py-0">
                                        <a class="d-block rounded-2 border"
                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/product-details.html') }}"><img
                                                src="{{ asset('back-end-links/phoenix/public/assets/img//products/60x60/2.png') }}" alt=""
                                                width="53" /></a>
                                    </td>
                                    <td class="align-middle product white-space-nowrap">
                                        <a class="fw-semi-bold"
                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/product-details.html') }}">iPhone 13 pro
                                    ...
                                    <td class="align-middle customer white-space-nowrap">
                                        <a class="d-flex align-items-center text-900"
                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/profile.html') }}">
                                            <div class="avatar avatar-l">
                                                <img class="rounded-circle" src="{{ asset('back-end-links/phoenix/public/assets/img/team/40x40/59.webp') }}"
                                                    alt="" />
                                            </div>
                                ...
                                <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                    ...
                                    <td class="align-middle product white-space-nowrap">
                                        <a class="fw-semi-bold"
                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/product-details.html') }}">Apple MacBook Pro 13
                                    ...
                                    <td class="align-middle customer white-space-nowrap">
                                        <a class="d-flex align-items-center text-900"
                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/profile.html') }}">
                                            <div class="avatar avatar-l">
                                                <img class="rounded-circle" src="{{ asset('back-end-links/phoenix/public/assets/img/team/40x40/58.webp') }}"
                                                    alt="" />
                                            </div>
                                ...
                                <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                    ...
                                    <td class="align-middle product white-space-nowrap py-0">
                                        <a class="d-block rounded-2 border"
                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/product-details.html') }}"><img
                                                src="{{ asset('back-end-links/phoenix/public/assets/img//products/60x60/4.png') }}" alt=""
                                                width="53" /></a>
                                    </td>
                                    <td class="align-middle product white-space-nowrap">
                                        <a class="fw-semi-bold"
                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/product-details.html') }}">Apple iMac 24&quot; 4K
                                            Retina Display M1 8 Core
                                            CPU...</a>
                                    </td>
                                    <td class="align-middle customer white-space-nowrap">
                                        <a class="d-flex align-items-center text-900"
                                            ...
                                            <div class="avatar avatar-l">
                                                <img class="rounded-circle avatar-placeholder"
                                                    src="{{ asset('back-end-links/phoenix/public/assets/img/team/40x40/avatar.webp') }}" alt="" />
                                            </div>
                                    ...
                                    <td class="align-middle review" style="min-width: 350px">
                                        <p class="fs--1 fw-semi-bold text-1000 mb-0">
                                            ...
                                            would use frequently. It's...<a href="#!">See more</a>
                                        </p>
                                    </td>
                                    <td class="align-middle text-start ps-5 status">
                                        <span class="badge badge-phoenix fs--2 badge-phoenix-warning"><span
                                ...
                                <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                    ...
                                    <td class="align-middle product white-space-nowrap py-0">
                                        <a class="d-block rounded-2 border"
                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/product-details.html') }}"><img
                                                src="{{ asset('back-end-links/phoenix/public/assets/img//products/60x60/5.png') }}" alt=""
                                                width="53" /></a>
                                    </td>
                                    <td class="align-middle product white-space-nowrap">
                                        <a class="fw-semi-bold"
                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/product-details.html') }}">Razer Kraken v3 x
                                            Wired 7.1 Surroung Sound Gam...</a>
                                    </td>
                                    <td class="align-middle customer white-space-nowrap">
                                        <a class="d-flex align-items-center text-900"
                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/profile.html') }}">
                                ...
                                <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                    ...
                                    <td class="align-middle product white-space-nowrap py-0">
                                        <a class="d-block rounded-2 border"
                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/product-details.html') }}"><img
                                                src="{{ asset('back-end-links/phoenix/public/assets/img//products/60x60/6.png') }}" alt=""
                                                width="53" /></a>
                                    </td>
                                    <td class="align-middle product white-space-nowrap">
                                        <a class="fw-semi-bold"
                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/product-details.html') }}">PlayStation 5
                                    ...
                                    <td class="align-middle customer white-space-nowrap">
                                        <a class="d-flex align-items-center text-900"
                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/profile.html') }}">
                                            <div class="avatar avatar-l">
                                                <img class="rounded-circle" src="{{ asset('back-end-links/phoenix/public/assets/img/team/40x40/57.webp') }}"
                                                    alt="" />
                                            </div>
                                ...
                                <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                    ...
                                    <td class="align-middle product white-space-nowrap py-0">
                                        <a class="d-block rounded-2 border"
                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/product-details.html') }}"><img
                                                src="{{ asset('back-end-links/phoenix/public/assets/img//products/60x60/7.png') }}" alt=""
                                                width="53" /></a>
                                    </td>
                                    <td class="align-middle product white-space-nowrap">
                                        <a class="fw-semi-bold"
                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/product-details.html') }}">2021 Apple 12.9-inch
                                            iPad Pro (Wi‑Fi, 128GB) -...</a>
                                    </td>
                                    <td class="align-middle customer white-space-nowrap">
                                        <a class="d-flex align-items-center text-900"
                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/profile.html') }}">
                                            <div class="avatar avatar-l">
                                                <img class="rounded-circle" src="{{ asset('back-end-links/phoenix/public/assets/img/team/40x40/3.webp') }}"
                                                    alt="" />
                                            </div>
                                ...
                                <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                    ...
                                    <td class="align-middle product white-space-nowrap py-0">
                                        <a class="d-block rounded-2 border"
                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/product-details.html') }}"><img
                                                src="{{ asset('back-end-links/phoenix/public/assets/img//products/60x60/8.png') }}" alt=""
                                                width="53" /></a>
                                    </td>
                                    <td class="align-middle product white-space-nowrap">
                                        <a class="fw-semi-bold"
                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/product-details.html') }}">Amazon Basics Matte
                                            Black Wired Keyboard - US ...</a>
                                    </td>
                                    <td class="align-middle customer white-space-nowrap">
                                        <a class="d-flex align-items-center text-900"
                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/profile.html') }}">
                                            <div class="avatar avatar-l">
                                                <img class="rounded-circle" src="{{ asset('back-end-links/phoenix/public/assets/img/team/40x40/26.webp') }}"
                                                    alt="" />
                                            </div>
                                ...
                                <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                    ...
                                    <td class="align-middle product white-space-nowrap py-0">
                                        <a class="d-block rounded-2 border"
                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/product-details.html') }}"><img
                                                src="{{ asset('back-end-links/phoenix/public/assets/img//products/60x60/9.png') }}" alt=""
                                                width="53" /></a>
                                    </td>
                                    <td class="align-middle product white-space-nowrap">
                                        <a class="fw-semi-bold"
                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/product-details.html') }}">Amazon Basics Mesh,
                                            Mid-Back, Swivel Office De...</a>
                                    </td>
                                    <td class="align-middle customer white-space-nowrap">
                                        <a class="d-flex align-items-center text-900"
                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/profile.html') }}">
                                            <div class="avatar avatar-l">
                                                <img class="rounded-circle" src="{{ asset('back-end-links/phoenix/public/assets/img/team/40x40/29.webp') }}"
                                                    alt="" />
                                            </div>
                                ...
                                <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                    ...
                                    <td class="align-middle product white-space-nowrap py-0">
                                        <a class="d-block rounded-2 border"
                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/product-details.html') }}"><img
                                                src="{{ asset('back-end-links/phoenix/public/assets/img//products/60x60/10.png') }}" alt=""
                                                width="53" /></a>
                                    </td>
                                    <td class="align-middle product white-space-nowrap">
                                        <a class="fw-semi-bold"
                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/product-details.html') }}">Apple Magic Mouse
                                            (Wireless, Rechargable) - Si...</a>
                                    </td>
                                    <td class="align-middle customer white-space-nowrap">
                                        <a class="d-flex align-items-center text-900"
                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/profile.html') }}">
                                ...
                                <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                    ...
                                    <td class="align-middle product white-space-nowrap py-0">
                                        <a class="d-block rounded-2 border"
                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/product-details.html') }}"><img
                                                src="{{ asset('back-end-links/phoenix/public/assets/img//products/60x60/11.png') }}" alt=""
                                                width="53" /></a>
                                    </td>
                                    <td class="align-middle product white-space-nowrap">
                                        <a class="fw-semi-bold"
                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/product-details.html') }}">Echo Dot (4th Gen) _
                                            Smart speaker with Alexa ...</a>
                                    </td>
                                    <td class="align-middle customer white-space-nowrap">
                                        <a class="d-flex align-items-center text-900"
                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/profile.html') }}">
                                            <div class="avatar avatar-l">
                                                <img class="rounded-circle" src="{{ asset('back-end-links/phoenix/public/assets/img/team/40x40/8.webp') }}"
                                                    alt="" />
                                            </div>
                                ...
                                <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                    ...
                                    <td class="align-middle product white-space-nowrap py-0">
                                        <a class="d-block rounded-2 border"
                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/product-details.html') }}"><img
                                                src="{{ asset('back-end-links/phoenix/public/assets/img//products/60x60/12.png') }}" alt=""
                                                width="53" /></a>
                                    </td>
                                    <td class="align-middle product white-space-nowrap">
                                        <a class="fw-semi-bold"
                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/product-details.html') }}">HORI Racing Wheel Apex
                                            for PlayStation 4_3, an...</a>
                                    </td>
                                    <td class="align-middle customer white-space-nowrap">
                                        <a class="d-flex align-items-center text-900"
                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/profile.html') }}">
                                ...
                                <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                    ...
                                    <td class="align-middle product white-space-nowrap py-0">
                                        <a class="d-block rounded-2 border"
                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/product-details.html') }}"><img
                                                src="{{ asset('back-end-links/phoenix/public/assets/img//products/60x60/13.png') }}" alt=""
                                                width="53" /></a>
                                    </td>
                                    <td class="align-middle product white-space-nowrap">
                                        <a class="fw-semi-bold"
                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/product-details.html') }}">Nintendo Switch with
                                            Neon Blue and Neon Red Jo...</a>
                                    </td>
                                    <td class="align-middle customer white-space-nowrap">
                                        <a class="d-flex align-items-center text-900"
                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/profile.html') }}">
                                            <div class="avatar avatar-l">
                                                <img class="rounded-circle" src="{{ asset('back-end-links/phoenix/public/assets/img/team/40x40/9.webp') }}"
                                                    alt="" />
                                            </div>
                                    ...
                                    <td class="align-middle review" style="min-width: 350px">
                                        <p class="fs--1 fw-semi-bold text-1000 mb-0">
                                            ...
                                            theme. It's really good and I ...<a href="#!">See more</a>
                                        </p>
                                    </td>
                                    <td class="align-middle text-start ps-5 status">
                                        <span class="badge badge-phoenix fs--2 badge-phoenix-warning"><span
                                ...
                                <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                    ...
                                    <td class="align-middle product white-space-nowrap py-0">
                                        <a class="d-block rounded-2 border"
                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/product-details.html') }}"><img
                                                src="{{ asset('back-end-links/phoenix/public/assets/img//products/60x60/14.png') }}" alt=""
                                                width="53" /></a>
                                    </td>
                                    <td class="align-middle product white-space-nowrap">
                                        <a class="fw-semi-bold"
                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/product-details.html') }}">Oculus Rift S
                                ...
                                <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                    ...
                                    <td class="align-middle product white-space-nowrap py-0">
                                        <a class="d-block rounded-2 border"
                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/product-details.html') }}"><img
                                                src="{{ asset('back-end-links/phoenix/public/assets/img//products/60x60/15.png') }}" alt=""
                                                width="53" /></a>
                                    </td>
                                    <td class="align-middle product white-space-nowrap">
                                        <a class="fw-semi-bold"
                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/product-details.html') }}">Sony X85J 75 Inch Sony
                                            4K Ultra HD LED Smart G...</a>
                                    </td>
                                    <td class="align-middle customer white-space-nowrap">
                                        <a class="d-flex align-items-center text-900"
                                            href="{{ asset('back-end-links/phoenix/public/apps/e-commerce/landing/profile.html') }}">
                                            <div class="avatar avatar-l">
                                                <img class="rounded-circle" src="{{ asset('back-end-links/phoenix/public/assets/img/team/40x40/24.webp') }}"
                                                    alt="" />
                                            </div>
                                ...
                                <thead>
                                    <tr>
                                        <th class="sort border-top border-200 ps-0 align-middle" scope="col"
                                            data-sort="country" style="width: 32%">
                                            COUNTRY
                                        </th>
                                        <th class="sort border-top border-200 align-middle" scope="col"
                                            data-sort="users" style="width: 17%">
                                            USERS
                                        </th>
                                        <th class="sort border-top border-200 text-end align-middle" scope="col"
                                            data-sort="transactions" style="width: 16%">
                                            TRANSACTIONS
                                        </th>
                                        <th class="sort border-top border-200 text-end align-middle" scope="col"
                                            data-sort="revenue" style="width: 20%">
                                            REVENUE
                                        </th>
                                        <th class="sort border-top border-200 text-end pe-0 align-middle"
                                            scope="col" data-sort="conv-rate" style="width: 17%">
                                            CONV. RATE
                                        </th>
                                    </tr>
                                </thead>
                                    ...
                                    <tr>
                                        <td class="white-space-nowrap ps-0 country" style="width: 32%">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <a href="#!">
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('back-end-links/phoenix/public/assets/img/country/india.png') }}" alt=""
                                                            width="24" />
                                                        <p class="mb-0 ps-3 text-primary fw-bold fs--1">
                                                            India
                                                        </p>
                                                    </div>
                                                </a>
                                    ...
                                    <tr>
                                        <td class="white-space-nowrap ps-0 country" style="width: 32%">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <a href="#!">
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('back-end-links/phoenix/public/assets/img/country/china.png') }}" alt=""
                                                            width="24" />
                                                        <p class="mb-0 ps-3 text-primary fw-bold fs--1">
                                                            China
                                                        </p>
                                    ...
                                    <tr>
                                        <td class="white-space-nowrap ps-0 country" style="width: 32%">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <a href="#!">
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('back-end-links/phoenix/public/assets/img/country/usa.png') }}" alt=""
                                                            width="24" />
                                                        <p class="mb-0 ps-3 text-primary fw-bold fs--1">
                                                            USA
                                                        </p>
                                    ...
                                    <tr>
                                        <td class="white-space-nowrap ps-0 country" style="width: 32%">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <a href="#!">
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('back-end-links/phoenix/public/assets/img/country/south-korea.png') }}" alt=""
                                                            width="24" />
                                                        <p class="mb-0 ps-3 text-primary fw-bold fs--1">
                                                            South Korea
                                                        </p>
                                    ...
                                    <tr>
                                        <td class="white-space-nowrap ps-0 country" style="width: 32%">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <a href="#!">
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('back-end-links/phoenix/public/assets/img/country/vietnam.png') }}" alt=""
                                                            width="24" />
                                                        <p class="mb-0 ps-3 text-primary fw-bold fs--1">
                                                            Vietnam
                                                        </p>
                                    ...
                                    <tr>
                                        <td class="white-space-nowrap ps-0 country" style="width: 32%">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <a href="#!">
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('back-end-links/phoenix/public/assets/img/country/russia.png') }}" alt=""
                                                            width="24" />
                                                        <p class="mb-0 ps-3 text-primary fw-bold fs--1">
                                                            Russia
                                                        </p>
                                    ...
                                    <tr>
                                        <td class="white-space-nowrap ps-0 country" style="width: 32%">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <a href="#!">
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('back-end-links/phoenix/public/assets/img/country/australia.png') }}" alt=""
                                                            width="24" />
                                                        <p class="mb-0 ps-3 text-primary fw-bold fs--1">
                                                            Australia
                                                        </p>
                                    ...
                                    <tr>
                                        <td class="white-space-nowrap ps-0 country" style="width: 32%">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <a href="#!">
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('back-end-links/phoenix/public/assets/img/country/england.png') }}" alt=""
                                                            width="24" />
                                                        <p class="mb-0 ps-3 text-primary fw-bold fs--1">
                                                            England
                                                        </p>
                                    ...
                                    <tr>
                                        <td class="white-space-nowrap ps-0 country" style="width: 32%">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <a href="#!">
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('back-end-links/phoenix/public/assets/img/country/indonesia.png') }}" alt=""
                                                            width="24" />
                                                        <p class="mb-0 ps-3 text-primary fw-bold fs--1">
                                                            Indonesia
                                                        </p>
                                    ...
                                    <tr>
                                        <td class="white-space-nowrap ps-0 country" style="width: 32%">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <a href="#!">
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('back-end-links/phoenix/public/assets/img/country/japan.png') }}" alt=""
                                                            width="24" />
                                                        <p class="mb-0 ps-3 text-primary fw-bold fs--1">
                                                            Japan
                                                        </p>
                            ...
                            <div class="text-center mt-auto">
                                <div class="avatar avatar-3xl status-online">
                                    <img class="rounded-circle border border-3 border-white"
                                        src="{{ asset('back-end-links/phoenix/public/assets/img/team/30.webp') }}" alt="" />
                                </div>
                ...
                <div class="row gx-2">
                    <div class="col-6">
                        ...
                        <label class="btn d-inline-block btn-navbar-style fs--1" for="themeSwitcherLight">
                            <span class="mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                                    src="{{ asset('back-end-links/phoenix/public/assets/img/generic/default-light.png') }}" alt="" /></span><span
                    ...
                    <div class="col-6">
                        ...
                        <label class="btn d-inline-block btn-navbar-style fs--1" for="themeSwitcherDark">
                            <span class="mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                                    src="{{ asset('back-end-links/phoenix/public/assets/img/generic/default-dark.png') }}" alt="" /></span><span
                ...
                <div class="row gx-2">
                    <div class="col-6">
                        ...
                        <label class="btn d-inline-block btn-navbar-style fs--1" for="navbarPositionVertical">
                            <span class="mb-2 rounded d-block"><img class="img-fluid img-prototype d-dark-none"
                                    src="{{ asset('back-end-links/phoenix/public/assets/img/generic/default-light.png') }}" alt="" /><img
                    ...
                    <div class="col-6">
                        ...
                        <label class="btn d-inline-block btn-navbar-style fs--1" for="navbarPositionHorizontal">
                            <span class="mb-2 rounded d-block"><img class="img-fluid img-prototype d-dark-none"
                                    src="{{ asset('back-end-links/phoenix/public/assets/img/generic/top-default.png') }}" alt="" /><img
                                    class="img-fluid img-prototype d-light-none"
                                    src="{{ asset('back-end-links/phoenix/public/assets/img/generic/top-default-dark.png') }}" alt="" /></span><span
                    ...
                    <div class="col-6">
                        ...
                        <label class="btn d-inline-block btn-navbar-style fs--1" for="navbarPositionCombo">
                            <span class="mb-2 rounded d-block"><img class="img-fluid img-prototype d-dark-none"
                                    src="{{ asset('back-end-links/phoenix/public/assets/img/generic/nav-combo-light.png') }}" alt="" /><img
                                    class="img-fluid img-prototype d-light-none"
                                    src="{{ asset('back-end-links/phoenix/public/assets/img/generic/nav-combo-dark.png') }}" alt="" /></span><span
                    ...
                    <div class="col-6">
                        ...
                        <label class="btn d-inline-block btn-navbar-style fs--1" for="navbarPositionTopDouble">
                            <span class="mb-2 rounded d-block"><img class="img-fluid img-prototype d-dark-none"
                                    src="{{ asset('back-end-links/phoenix/public/assets/img/generic/dual-light.png') }}" alt="" /><img
                                    class="img-fluid img-prototype d-light-none"
                                    src="{{ asset('back-end-links/phoenix/public/assets/img/generic/dual-dark.png') }}" alt="" /></span><span
                ...
                <div class="row gx-2">
                    <div class="col-6">
                        ...
                        <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-default">
                            <img class="img-fluid img-prototype d-dark-none"
                                src="{{ asset('back-end-links/phoenix/public/assets/img/generic/default-light.png') }}" alt="" /><img
                                class="img-fluid img-prototype d-light-none"
                                src="{{ asset('back-end-links/phoenix/public/assets/img/generic/default-dark.png') }}" alt="" /><span
                    ...
                    <div class="col-6">
                        ...
                        <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-dark">
                            <img class="img-fluid img-prototype d-dark-none"
                                src="{{ asset('back-end-links/phoenix/public/assets/img/generic/vertical-darker.png') }}" alt="" /><img
                                class="img-fluid img-prototype d-light-none"
                                src="{{ asset('back-end-links/phoenix/public/assets/img/generic/vertical-lighter.png') }}" alt="" /><span
                ...
                <div class="row gx-2">
                    ...
                    <div class="col-6">
                        ...
                        <label class="btn d-inline-block btn-navbar-style fs--1" for="navbarShapeSlim">
                            <span class="mb-2 rounded d-block"><img class="img-fluid img-prototype d-dark-none mb-0"
                                    src="{{ asset('back-end-links/phoenix/public/assets/img/generic/top-slim.png') }}" alt="" /><img
                                    class="img-fluid img-prototype d-light-none mb-0"
                                    src="{{ asset('back-end-links/phoenix/public/assets/img/generic/top-slim-dark.png') }}" alt="" /></span><span
                    ...
                    <div class="col-6">
                        ...
                        <label class="btn d-inline-block btn-navbar-style fs--1" for="navbarTopDefault">
                            <span class="mb-2 rounded d-block"><img class="img-fluid img-prototype d-dark-none mb-0"
                                    src="{{ asset('back-end-links/phoenix/public/assets/img/generic/top-default.png') }}" alt="" /><img
                                    class="img-fluid img-prototype d-light-none mb-0"
                                    src="{{ asset('back-end-links/phoenix/public/assets/img/generic/top-style-darker.png') }}" alt="" /></span><span
                                class="label-text">Default</span></label>
                    </div>
                    <div class="col-6">
                        ...
                        <label class="btn d-inline-block btn-navbar-style fs--1" for="navbarTopDarker">
                            <span class="mb-2 rounded d-block"><img class="img-fluid img-prototype d-dark-none mb-0"
                                    src="{{ asset('back-end-links/phoenix/public/assets/img/generic/navbar-top-style-light.png') }}" alt="" /><img
                                    class="img-fluid img-prototype d-light-none mb-0"
                                    src="{{ asset('back-end-links/phoenix/public/assets/img/generic/top-style-lighter.png') }}" alt="" /></span><span
                                class="label-text d-dark-none">Darker</span><span
                                class="label-text d-light-none">Lighter</span></label>
                    </div>
                </div>
    ...
    <script src="{{ asset('back-end-links/phoenix/public/vendors/leaflet.markercluster/leaflet.markercluster.js') }}"></script>
    <script src="{{ asset('back-end-links/phoenix/public/vendors/leaflet.tilelayer.colorfilter/leaflet-tilelayer-colorfilter.min.js') }}"></script>
